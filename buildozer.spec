...
# (str) Package name
package.name = googlephotosmanager
...
requirements = python3,kivy==2.2.1,kivymd==1.1.1,pillow,opencv-python,numpy,pyjnius,plyer,android
...
# (int) Android aapt2 version to use
#android.aapt2_version = 7.0.0-alpha01

# (str) Python library used to build the app
#p4a.bootstrap = sdl2

# (int) port number to specify an explicit --port= p4a argument (eg for flask/django projects etc)
#p4a.port =
...
# setup.py if you're using Poetry, but you need to set this to true
# (bool) enable/disable setuptools integration
#p4a.setup_py = false
